...
// LEVEL THREE //
            ...
            Console.ReadLine();
            Console.Clear();
            Console.WriteLine("A beautiful morning on Mt. Rustic... Time to get to it! I just know I'm going to find more X-ORBS today!!");
            Console.ReadLine();
            Console.Clear();
            ...
            Console.ReadLine();
            Console.Clear();
            Console.WriteLine("!!!!! --- WITHIN SECONDS YOU ARE SOARING ABOVE THE TREES OF MT RUSTIC! THE X-ORB IS WORKING!!");
            Console.ReadLine();
            Console.Clear();
            Console.WriteLine("AS YOU SOAR DOWN MT. RESTIC, THE TREELINE SOON GIVES WAY TO CONCRETE AND BUILDINGS --- \nYOUR HOMETOWN OF VALORIA.");
            Console.ReadLine();
            Console.Clear();
...
bool fightTwo=false;
            ...
            Console.ReadLine();
            Console.Clear();
            Console.WriteLine("HE JUKES LEFT AND DODGES!! JAX SEND A TORNADO TOWARDS YOU!!");
            Console.ReadLine();
            Console.Clear();
